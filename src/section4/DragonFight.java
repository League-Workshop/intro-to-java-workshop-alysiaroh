...
public class DragonFight {
	...
	int playerHealth = 100;
		...
		String response = JOptionPane.showInputDialog("Attack the dragon with a yell or a kick:");
		// 9. If they typed in "yell":
		if(response.equals("yell")) {
			Random randGen=new Random();
			int r=randGen.nextInt(11);
			dDamage=r;
	   ...
	   //  15.  Else
			...
			JOptionPane.showMessageDialog(null, "You have "+playerHealth+" health while the dragon has "+dragonHealth+" health.");
		}
